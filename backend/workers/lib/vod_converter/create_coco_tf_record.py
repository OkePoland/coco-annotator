...
tf.flags.DEFINE_string('train_image_dir', '/home/bielinski/Desktop/Datasets/Pascal_voc/VOCtrainval_11-May-2012/VOCdevkit/VOC2012/JPEGImages',
                       'Training image directory.')
tf.flags.DEFINE_string('val_image_dir', '/home/bielinski/Desktop/Datasets/Pascal_voc/VOCtrainval_11-May-2012/VOCdevkit/VOC2012/JPEGImages',
                       'Validation image directory.')
tf.flags.DEFINE_string('test_image_dir', '',
                       'Test image directory.')
tf.flags.DEFINE_string('train_annotations_file', '/home/bielinski/Desktop/Datasets/Pascal_voc/coco_from_pascal/pascal_voc_from_my_annotator.json',
...
def _create_tf_record_from_coco_annotations(
    groundtruth_data, image_dir, output_path, include_masks, num_shards):
...
def main(_):
  ...
  assert FLAGS.val_size, '`size of validation set missing'
 ...
 #assert FLAGS.testdev_annotations_file, '`testdev_annotations_file` missing.'
  ...
  train_annotation, val_annotation = _split_dataset(FLAGS.train_annotations_file, FLAGS.val_size)
